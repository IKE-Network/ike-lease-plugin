...
canonical_url: https://ike.network/ike-base-parent/ike-lease/ike-lease-plugin/project-info.html
---
...
| [About](index.html)[5] | The IDE host of the lease core: opening a project acquires its lease and materializes its git state; being fenced by a takeover elsewhere saves open documents and closes the project; sibling pushes to remote remotes abort in the push dialog. Ships as a zip bundling this jar and ike-lease-core under lib/. |
